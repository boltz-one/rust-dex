...
Icons are a big part of the app, and they're how we convey hundreds of actions without relying on labeled buttons.
...
Then, they're modified, adjusted, cleaned up, and simplified depending on their use and overall fit with the app.
...
Make sure to tag a member of the design team so we can review and adjust any newly introduced icon.
