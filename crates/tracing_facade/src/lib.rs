...
#[cfg(not(tracing_facade))]
pub use tracing_facade_macros::instrument;

#[cfg(tracing_facade)]
const MAX_CALLSTACK_DEPTH: u16 = 16;

#[cfg(all(tracing_facade, tracing_facade_with_memory))]
#[global_allocator]
...
pub fn init() {
    ...
    logging::info!("Starting tracy subscriber, you can now connect the profiler");
